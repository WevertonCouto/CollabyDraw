            ...
            <div className="welcome-screen-center z-[3]">
                <div className="welcome-screen-center__logo collabyfont welcome-screen-decor">
                    <div className="CollabydrawLogo is-small">
                        ...
                        <h1 className="brand-title CollabydrawLogo-text font-collabyfont">beehive</h1>
                    </div>
                </div>
                <div className="welcome-screen-center__heading welcome-screen-decor font-collabyfont">Conecte-se e crie juntos. Transforme ideias em arte colaborativa em tempo real.</div>
